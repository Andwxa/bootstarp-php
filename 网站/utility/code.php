<?php
/*
 * @Date: 2022-05-30 22:36:59
 * @LastEditors: Andwxa
 * @LastEditTime: 2022-06-02 19:31:44
...
$char = array_merge(range('A','H'), range('K','N'),range('R','Y'),range('a','h'),range('t','u'),range('x','y'),range(3, 4),range(8, 9));
